 ...
 * @author mboon
 */
public class GammaDistributionReturnValues extends Distribution {

    protected double alpha, beta;
    
    public GammaDistributionReturnValues(double alpha, double beta, Random random) {
        this.alpha = alpha;
        this.beta = beta;
        this.random = random;
    }
    ...
    public static void main(String[] arg) {
        double sumX = 0;
        double sumX2 = 0;
        GammaDistributionReturnValues dist = new GammaDistributionReturnValues(0.5, 0.25, new Random());
        int n = 100000;
        for (int i = 0; i < n; i++) {
